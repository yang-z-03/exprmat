...
def license(): print(LICENSE_MESSAGE)

def view(fpath, cmd = 'less -S'): os.system(
    cmd + ' "' + os.path.join(os.path.dirname(__file__), fpath) + '"'
)
...
try:
    ...
    with os.fdopen(fd, "w") as f: f.write(ver_string)
    license()
